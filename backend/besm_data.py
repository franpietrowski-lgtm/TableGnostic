...
CLASS_TEMPLATES = [
    ...
    # V6.25.45 — extended class roster per user request: Demon Hunter,
    # Idol, Pet Trainer, plus three more thematic archetypes to round
    # out the catalogue (Aurae Acolyte, Mortiscure Initiate, Wandering
    # Monk). All costed against the same BESM 4E framework (p.142–153
    # archetype family). Pages set to None where the archetype is
    # platform-extended (not in the core book itself).
    {"name": "Demon Hunter", "cp_cost": 22, "page": None,
     "summary": "Anti-supernatural specialist. Weapon-bond + ward sense.",
     "bundle": [
        {"kind": "attribute",   "name": "Weapon",            "level": 5,
         "note": "Hallowed/silvered. Half-cost (p.135)."},
        {"kind": "attribute",   "name": "Heightened Awareness", "level": 1,
         "note": "Detect occult / unholy"},
        {"kind": "skill_group", "name": "Knowledge",         "level": 1,
         "note": "Occult lore"},
        {"kind": "attribute",   "name": "Tough",             "level": 1},
        {"kind": "defect",      "name": "Vow",               "rank": 2,
         "note": "Sworn to hunt the darkness"},
     ]},
    {"name": "Idol (Stage Caster)", "cp_cost": 16, "page": None,
     "summary": "Performer whose audience is the spell. Charisma + signature.",
     "bundle": [
        {"kind": "skill_group", "name": "Performing Arts",   "level": 3},
        {"kind": "attribute",   "name": "Aura of Inhuman Beauty", "level": 1},
        {"kind": "attribute",   "name": "Power Pack",        "level": 1,
         "note": "Crowd-channelled magic"},
        {"kind": "attribute",   "name": "Wealth",            "level": 1,
         "note": "Sponsorships & merch"},
        {"kind": "defect",      "name": "Marked",            "rank": 1,
         "note": "Cannot move unrecognised"},
     ]},
    {"name": "Pet Trainer (Bonded Multitude)", "cp_cost": 18, "page": None,
     "summary": "Multiple smaller Companion animals. Crowd-control via beasts.",
     "bundle": [
        {"kind": "attribute",   "name": "Companion",          "level": 3,
         "note": "Pack of smaller beasts. Half-cost — split across multiple companions."},
        {"kind": "skill_group", "name": "Animal Training",    "level": 2},
        {"kind": "skill_group", "name": "Survival",           "level": 1},
        {"kind": "attribute",   "name": "Heightened Senses",  "level": 1},
        {"kind": "defect",      "name": "Owned",              "rank": 1,
         "note": "Bonded to a keeper / menagerie"},
     ]},
    {"name": "Aurae Acolyte", "cp_cost": 16, "page": None,
     "summary": "Channels a Face of Aurae. Glow-aligned support caster.",
     "bundle": [
        {"kind": "attribute",   "name": "Power Pack",         "level": 2,
         "note": "Aurae-aligned. GM may gate certain Faces by primer."},
        {"kind": "attribute",   "name": "Healing",            "level": 1},
        {"kind": "skill_group", "name": "Knowledge",          "level": 1,
         "note": "Aurae lore"},
        {"kind": "attribute",   "name": "Aura of Inhuman Beauty", "level": 1},
        {"kind": "defect",      "name": "Marked",             "rank": 1,
         "note": "Auric sigil visible at night"},
     ]},
    {"name": "Mortiscure Initiate", "cp_cost": 18, "page": None,
     "summary": "Channels a Face of Mortiscure. Wound-aligned striker / curser.",
     "bundle": [
        {"kind": "attribute",   "name": "Power Pack",         "level": 2,
         "note": "Mortiscure-aligned. GM may gate certain Faces by primer."},
        {"kind": "attribute",   "name": "Massive Damage",     "level": 1,
         "note": "Bleed / decay signature"},
        {"kind": "attribute",   "name": "Heightened Awareness", "level": 1,
         "note": "Detect death / undeath"},
        {"kind": "skill_group", "name": "Knowledge",          "level": 1,
         "note": "Mortiscure lore"},
        {"kind": "defect",      "name": "Marked",             "rank": 2,
         "note": "Mortiscure brand seeps cold"},
     ]},
    {"name": "Wandering Monk", "cp_cost": 16, "page": None,
     "summary": "Unarmed striker + meditative resilience. Travelling philosopher.",
     "bundle": [
        {"kind": "attribute",   "name": "Massive Damage",     "level": 1,
         "note": "Unarmed signature"},
        {"kind": "attribute",   "name": "Tough",              "level": 2},
        {"kind": "attribute",   "name": "Speed",              "level": 1},
        {"kind": "skill_group", "name": "Athletics",          "level": 1},
        {"kind": "skill_group", "name": "Knowledge",          "level": 1,
         "note": "Meditation / philosophy"},
        {"kind": "defect",      "name": "Vow",                "rank": 1,
         "note": "Sworn to wander"},
     ]},
]
