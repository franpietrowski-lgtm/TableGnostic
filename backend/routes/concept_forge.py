...
_SUPPORTED_SYSTEMS = {"besm-4e", "anime-5e", "dnd-5e", "cypher"}
...
def _build_system_prompt(system_id: str) -> str:
    ...
    if system_id == "dnd-5e":
        return (
            "You are a D&D 5E SRD character-design assistant. Output STRICT JSON.\n\n"
            "TIER awareness: T1 levels 1-4 (low magic, single-encounter focus); "
            "T2 5-10 (regional heroes, named monsters); T3 11-16 (continental + planar); "
            "T4 17-20 (cosmic, godlike opposition). Match spell list, gear and rationale "
            "to the campaign's stated power level / tier. The level the character is "
            "BUILT AT must respect the campaign's `Power Level` mapping if present.\n\n"
            "WARLOCK awareness: if the brief or class lands on Warlock, ALWAYS pick a "
            "canonical Otherworldly Patron (Archfey / Fiend / Great Old One / Celestial / "
            "Hexblade / Genie / Fathomless / Undead) AND a Pact Boon (Tome / Blade / Chain / "
            "Talisman) AND list 1-2 hallmark Eldritch Invocations.\n\n"
            ...
            "      \"race\":   \"<SRD race or canonical demon-heritage>\",\n"
            "      \"class\":  \"<SRD class>\",\n"
            "      \"subclass\":\"<canonical subclass>\", \"background\":\"<background>\",\n"
            "      \"tier\":  <1|2|3|4>, \"level\": <int>,\n"
            "      \"abilities\":  {\"STR\":<int>,\"DEX\":<int>,\"CON\":<int>,\"INT\":<int>,\"WIS\":<int>,\"CHA\":<int>},\n"
            "      \"saves_proficient\": [\"<ability>\"],\n"
            "      \"skills_proficient\": [\"<skill>\"],\n"
            "      \"feats\":      [\"<feat>\"],\n"
            "      \"cantrips\":   [\"<cantrip>\"],\n"
            "      \"spells\":     [{\"level\":<int>,\"name\":\"\"}],\n"
            "      \"patron\":     \"<patron name or empty>\",\n"
            "      \"pact\":       \"<Tome|Blade|Chain|Talisman or empty>\",\n"
            "      \"invocations\":[\"<invocation>\"],\n"
            "      \"items\":      [{\"name\":\"\",\"category\":\"\",\"note\":\"\"}],\n"
            "      \"weapons\":    [{\"name\":\"\",\"class\":\"Melee|Ranged|Thrown|Firearm\","
            "\"damage_dice\":\"1d8\",\"damage_type\":\"slashing\",\"properties\":[],\"note\":\"\"}],\n"
            "      \"armor\":      \"<armor name or empty>\",\n"
            "      \"hit_points\":  <int>,\n"
            "      \"rationale\":   \"<short>\"\n"
            "    },\n"
            ...
            "}\n\n"
            "Rules:\n"
            "- EXACTLY 2 candidates, mechanically distinct (different subclass / different patron / different pact).\n"
            "- abilities total ≤ 27 point-buy + racial bonuses by default.\n"
            "- Spells appropriate to the tier (no 5th-level spells at L4).\n"
            "- Respect ALL primer caps + allow/prohibit lists strictly.\n"
            "- DO NOT output prose outside the JSON. DO NOT wrap in markdown fences."
        )
    if system_id == "cypher":
        return (
            "You are a Cypher System character-design assistant. Output STRICT JSON.\n\n"
            "Cypher uses a sentence-style descriptor + type + focus character "
            "(\"a {Descriptor} {Type} who {Focus}\"). TYPE pool: Warrior, Adept, "
            "Explorer, Speaker. FOCUS examples: 'Bears a Halo of Fire', 'Talks to Machines', "
            "'Wields Power with Precision', 'Howls at the Moon', 'Masters Weaponry'. "
            "DESCRIPTOR examples: Strong, Clever, Tough, Graceful, Mystical, Stealthy.\n\n"
            "Genre awareness: Cypher is genre-agnostic — adapt artifact / cypher / setting "
            "elements to the campaign's stated genre (sci-fi / fantasy / horror / "
            "post-apoc / superhero). Mention the genre in the rationale.\n\n"
            "TIERS run 1-6 (1=novice, 6=demigod). Use the campaign's power level to set tier.\n\n"
            "Schema:\n"
            "{\n"
            "  \"candidates\": [\n"
            "    {\n"
            ...
            "      \"appearance\":\"\", \"origin\":\"\",\n"
            "      \"goals\":[], \"dreams\":[], \"personality_knots\":\"\", \"history\":[],\n"
            "      \"sentence\":   \"a {Descriptor} {Type} who {Focus}\",\n"
            "      \"descriptor\": \"<descriptor>\",\n"
            "      \"type\":       \"Warrior|Adept|Explorer|Speaker\",\n"
            "      \"focus\":      \"<focus>\",\n"
            "      \"tier\":       <1-6>,\n"
            "      \"pools\":      {\"Might\":<int>,\"Speed\":<int>,\"Intellect\":<int>},\n"
            "      \"edges\":      {\"Might\":<int>,\"Speed\":<int>,\"Intellect\":<int>},\n"
            "      \"effort\":     <int>,\n"
            "      \"abilities\":  [\"<tier-1 ability>\"],\n"
            "      \"skills\":     [{\"name\":\"\",\"category\":\"trained|specialized|inability\"}],\n"
            "      \"cyphers\":    [{\"name\":\"\",\"level\":<int>,\"effect\":\"\"}],\n"
            "      \"artifacts\":  [{\"name\":\"\",\"level\":<int>,\"effect\":\"\",\"depletion\":\"d6/d10\"}],\n"
            "      \"items\":      [{\"name\":\"\",\"category\":\"\",\"note\":\"\"}],\n"
            "      \"weapons\":    [{\"name\":\"\",\"class\":\"Light|Medium|Heavy|Ranged\","
            "\"damage\":<int>,\"note\":\"\"}],\n"
            "      \"genre_tag\":  \"<genre>\",\n"
            "      \"rationale\":  \"<short>\"\n"
            "    },\n"
            ...
            "}\n\n"
            "Rules:\n"
            "- EXACTLY 2 candidates, distinct on Type or Focus.\n"
            "- Cypher limit: max 2 cyphers carried by tier 1 (Warriors), 3 (Adepts), 2 (Explorers/Speakers).\n"
            "- Pools default per type: Warrior 11/10/7, Adept 7/9/12, Explorer 10/10/8, Speaker 8/8/12 (then add 6 to distribute).\n"
