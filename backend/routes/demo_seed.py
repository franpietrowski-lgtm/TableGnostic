...
EVEREANTHA = {
    ...
    "nodes": [
        {"type": "location", "title": "Aurea, the Forge-Glass City", "tags": ["evereantha", "city"],
         "summary": "Capital of the Reach. Foundries throw red light over a city that runs on songs."},
        {"type": "location", "title": "Solar-Lunar Caldera", "tags": ["evereantha", "site"],
         "summary": "Twin-eye crater above the city where the eclipse will land."},
        {"type": "faction", "title": "Order of the Darkening Star", "tags": ["evereantha", "antagonist"],
         "summary": "Star-cult that intends to crack the Caldera open during the next eclipse."},
        {"type": "lore", "title": "The Forge-Glass Hammer", "tags": ["evereantha", "macguffin"],
         "summary": "Lost relic that can either seal the Caldera or shatter it. Two singers know its hum."},
        {"type": "npc", "title": "Mayor Mishtee", "tags": ["evereantha", "ally"],
         "summary": "Pragmatic leader who hired the apprentices. Trusts the table — for now."},
        {"type": "npc", "title": "Malshe Darkening", "tags": ["evereantha", "nemesis"],
         "summary": "Star-Cult Hierophant. Patient, reverent, never raises voice. Plot-keyed."},
        {"type": "npc", "title": "Frock the Iron-Cantor", "tags": ["evereantha", "henchman"],
         "summary": "Forge-Cantor. Servile then mocking. Tests apprentices."},
    ],
